...
def build_drive_service(credentials: Dict[str, Any]) -> DriveService:
    """
    Build and return a DriveService instance with the provided credentials.
    ...
    """
    logger.info("Building Drive service with provided credentials")
