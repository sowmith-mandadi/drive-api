...
class ContentProcessor:
    ...
    async def process_content_item(
        self, content_data: Dict[str, Any], file_url: Optional[str] = None, drive_file_id: Optional[str] = None
        ...
        try:
            ...
            if drive_file_id and isinstance(drive_file_id, str) and drive_file_id.strip():
                ...
                success, message, file_info = await self._process_file_from_drive(content_id, drive_id)
            ...
            # Process file URL if provided
                ...
                # Check if it's a Drive URL
                    ...
                    if drive_id:
                        ...
                        # Process regular URL
                        success, message, file_info = await self._process_file_from_url(content_id, file_url)
                        if success and file_info:
                            content_data["fileUrls"].append(file_info)
        ...
        try:
            ...
            if mime_type.startswith('application/vnd.google-apps.'):
                try:
                    ...
                    return False, f"Failed to export Google Workspace file: {str(export_error)}", None
            else:
                # Regular file
                try:
                ...
                with open(temp_file_path, 'wb') as f:
                    ...
                    while not done and retry_count < max_retries:
                        try:
                            ...
                            logger.warning(f"Error downloading chunk, attempt {retry_count+1}: {str(chunk_error)}")
                            retry_count += 1
