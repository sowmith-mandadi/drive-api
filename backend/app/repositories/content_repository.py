...
class ContentRepository:
    ...
    def create(self, content_data: ContentCreate, content_id: str = None) -> Optional[ContentInDB]:
    ...
    def search(self, query: str = None, filters: Dict[str, Any] = None) -> List[ContentInDB]:
            ...
            if filters:
                ...
                for content in contents:
                    ...
                    for key, value in filters.items():
                        ...
                        if key.startswith("metadata."):
                            metadata_key = key.split(".", 1)[1]
                            if metadata_key not in content.metadata or content.metadata[metadata_key] != value:
                                include = False
                                break
    ...
    def update_extracted_text(self, content_id: str, extracted_text: str,
                             page_content: Dict[str, str]) -> bool:
