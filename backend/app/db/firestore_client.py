...
class FirestoreClient:
        ...
        try:
            ...
            if credentials_path and os.path.exists(credentials_path):
                ...
                if settings.FIRESTORE_EMULATOR_HOST:
                    ...
                    logger.info(f"Initialized Firestore client with emulator at {settings.FIRESTORE_EMULATOR_HOST}")
                else:
    ...
    def list_documents(self, collection: str, limit: int = 100, 
                       offset: int = 0, order_by: str = None,
                       filters: List[tuple] = None) -> List[Dict[str, Any]]:
    ...
    def search_documents(self, collection: str, query_text: str, fields: List[str], 
                         limit: int = 100, filters: List[tuple] = None) -> List[Dict[str, Any]]:
