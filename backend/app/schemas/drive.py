...
class DriveFolder(BaseModel):
    ...
    mimeType: str = Field("application/vnd.google-apps.folder", 
                          description="MIME type for Google Drive folder")
    createdTime: Optional[datetime] = Field(None, 
...
class DriveFile(BaseModel):
    ...
    webViewLink: Optional[HttpUrl] = Field(None, 
                                         description="URL to view the file in browser")
    thumbnailLink: Optional[HttpUrl] = Field(None, 
                                           description="URL to thumbnail image")
    createdTime: Optional[datetime] = Field(None, 
                                          description="File creation timestamp")
    modifiedTime: Optional[datetime] = Field(None, 
...
class DriveImportResponse(BaseModel):
    ...
    content_ids: Optional[List[str]] = Field(None, 
                                           description="IDs of created content items")
    error_details: Optional[Dict[str, str]] = Field(None, 
